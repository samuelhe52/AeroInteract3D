...
# Minimal pinch-angle rotation channel tuning.
ROT_GAIN = 1.55
# Use cyclic slots instead of capped degrees; more slots gives smoother feel.
ROT_SLOT_COUNT = 10
ROT_SLOT_STEP_DEG = 360.0 / ROT_SLOT_COUNT
ROT_STEP_ACCUM_MIN_DEG = 1.0
ROT_GATE_FRAMES = 3
ROT_GATE_RELEASE_FRAMES = 1
ROT_WRIST_STILL_SPEED = 1.8
ROT_WRIST_MOVE_SPEED = 6.0
ROT_PINCH_ANGULAR_ACTIVE_DEG = 2.5
ROT_PINCH_ANGULAR_STILL_DEG = 0.8
ROT_DELTA_CLAMP_DEG = 14.0
ROT_DELTA_NOISE_DEG = 0.08
ROT_OPPOSITE_JITTER_SUPPRESS_DEG = 1.2
ROT_TREND_MIN_DEG = 0.6
ROT_TRANSLATION_BLOCK_MIN_MOVE = 0.010
ROT_TRANSLATION_BLOCK_COS = 0.90
ROT_TRANSLATION_BLOCK_MAG_DIFF = 0.008
ROT_STACK_CLEAR_IDLE_FRAMES = 6
ROT_MODE_ACTIVATE_CYCLES = 2
ROT_MODE_WINDOW_FRAMES = 40
ROT_MODE_PINCH_MIN_FRAMES = 1
ROT_MODE_PINCH_MAX_FRAMES = 16
