                ...
                if key == "rotate":
                    ...
                    for finger_index in range(5):
                        finger = DirectFrame(
                            parent=rotate_stage,
                            pos=(0, 0, 0),
                            frameSize=(-self.ROTATE_FINGER_HALF_SIZE, self.ROTATE_FINGER_HALF_SIZE, -self.ROTATE_FINGER_HALF_SIZE, self.ROTATE_FINGER_HALF_SIZE),
        ...
        for demo in self._demo_cards:
            ...
            if key == "drag":
                ...
                if isinstance(rotate_fingers, list) and rotate_fingers and rotate_stage_width > 0.0 and rotate_stage_height > 0.0:
                    ...
                    if isinstance(rotate_mode_label, NodePath):
                        rotate_mode_label.node().setText("move" if five_phase < (0.34 + 0.3 / self.UPPER_ROTATE_CYCLE_SECONDS) else "rotate")
